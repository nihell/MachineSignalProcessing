...
plt.savefig("GoF-test-powers{}.pdf".format(mc_iterations))
plt.show()

np.savetxt("{}test_powers_alpha1.1-2_amplitude0-2.txt".format(mc_iterations),np.array(test_powers_alpha))